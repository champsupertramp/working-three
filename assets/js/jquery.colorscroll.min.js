!function (o) {
    ...
    var s = "colorScroll", e = window.document, r = o(e), i = o(window), n = {UPDATE: "update.colorScroll"}, l = {colors: [
        {color: "#FFFFFF", position: "0%"},
        {color: "#000000", position: "100%"}
    ], scrollElement: r, fauxScroll: !1}, c = function () {
    ...
    t.prototype = {colors: [], init: function () {
        ...
        for (var o = r.height() - i.height(), t = [], s = 0; s < this.options.colors.length; s++) {
            ...
            e.color = this.options.colors[s].color, e.position = "string" == typeof n ? "%" === n.charAt(n.length - 1) ? Math.floor(parseFloat(n) * o / 100) : parseFloat(n) : n, t.push(e)
        }
        ...
        o !== this.currentColor && (this.$element.css("background-color", o), this.currentColor = o, this.$element.trigger(n.UPDATE, {color: o}))
    }}, o.fn[s] = function (e) {
    ...
    "use strict";
    var t, s, e = o.event;
    t = e.special.debouncedresize = {setup: function () {
